...
class App(customtkinter.CTk):
    ...
    def btn_convertir_c_f_on_click(self):
        ...
        temperatura_convertida = (temperatura_c * 1.8) + 32
        alert("Temperatura", "La temperatura convertida sería de {} °F" .format(temperatura_convertida))


    def btn_convertir_f_c_on_click(self):
        temperatura_f = float(self.txt_temperatura_f.get())
        temperatura_convertida = round(((temperatura_f - 32) * float(5 / 9)),2)
        alert("Temperatura", "La temperatura convertida sería de {} °C" .format(temperatura_convertida,2))
